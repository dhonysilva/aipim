defmodule Aipim.ShoppingCart do
  @moduledoc """
  ...
  alias Aipim.Catalog
  alias Aipim.ShoppingCart.Cart
  alias Aipim.ShoppingCart.CartItem
  ...
  def reload_cart(%Cart{} = cart), do: get_cart_by_user_id(cart.user_id)
